        ...
        children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      _selectedSliceIndex != null
                          ? '₹${NumberFormat('#,##,###').format(widget.categories[_selectedSliceIndex!].amountMinor ~/ 100)}'
          ...
          ...List.generate(widget.categories.length, (index) {
            ...
            return InkWell(
              onTap: () {
                setState(() {
                  _selectedSliceIndex = isSelected ? null : index;
                });
              },
              ...
              child: AnimatedContainer(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      '₹${NumberFormat('#,##,###').format(cat.amountMinor ~/ 100)}',
                      style: GoogleFonts.inter(
                        fontSize: 13,
                        fontWeight: FontWeight.w700,
                        color: AppColors.neutralDark,
